...
# imgpath <- "working/sinkr2vert.png"
imgpath <- ".github/figures/trashcan_pixel64.png"
# imgpath <- "working/trashcan2_pixel.png"
...
sticker(imgpath, package="sinkr", 
  h_size = 1, h_color = "black", h_fill = "#F1FF71", 
  p_x = 1, p_y = 1.575, p_size = 40, p_color = "black",
  url = "github.com/marchtaylor/sinkr", u_x = 1.05, u_y = 0.1, u_size = 10, u_angle = 30,
  p_family = p_family, 
  s_x = 1, s_y = 0.85, s_width = .55, dpi = 600,
  filename = ".github/figures/hexSticker_sinkr.png")
