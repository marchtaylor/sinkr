...
#' Signal1 <- sin(as.POSIXlt(Time)$mon/11*(2*pi)) # annual signal
#' Signal2 <- sin(as.POSIXlt(Time)$yday/365*(4*pi)) # quarterly signal
...
#' pal <- colorPalette(c("blue4", "green", "white", "orange", "red4"), c(10,1,1,10))
